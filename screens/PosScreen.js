  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable style={styles.card} onPress={handlePressOne}>
        ...
        <Text style={styles.cardHeader}>Pos Mainnet</Text>
        <Text style={styles.cardDescription}>mainnet</Text>
      </Pressable>
      ...
      <Pressable style={styles.card} onPress={handlePressTwo}>
        ...
        <Text style={styles.cardHeader}>Amoy Testnet</Text>
        <Text style={styles.cardDescription}>testnet</Text>
      </Pressable>
    </View>
  );
}
